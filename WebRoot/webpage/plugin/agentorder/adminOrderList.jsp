...
<%@include file="/context/mytags.jsp"%>
  <t:datagrid name="adminOrderList" title="订单列表" actionUrl="agentOrderController.do?adminOrderGrid" idField="id" fit="true" >
   ...
   <t:dgCol title="代理商" field="companyName" width="25" ></t:dgCol>
 ...
 <div id="adminOrderListtb" style="padding: 3px; height: 25px">
	 <div align="right">
	          订单号:
	    ...
	    <a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="adminOrderListsearch()">查询</a>
	 </div>
  </div>
