       ...
       <input type="hidden" id=type name="type" value="1" />
		<fieldset class="step">
		    ...
		    <div class="form">
	           ...
	           <t:choose hiddenName="actId" hiddenid="id" url="pluginActController.do?pluginList" name="pluginActList" icon="icon-choose" title="活动列表" textname="title" isclear="true"></t:choose>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
