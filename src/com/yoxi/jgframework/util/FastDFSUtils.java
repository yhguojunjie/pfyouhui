...
public class FastDFSUtils {
	...
	public static String CONF_FILENAME = FileUtils.getWebRootPath() + File.separatorChar + "WEB-INF"
					+ File.separatorChar + "classes" + File.separatorChar + "fdfs_client.conf";
	...
	public static void main(String[] args) throws Exception{
		String local_file_name = "D:\\11.jpg";
