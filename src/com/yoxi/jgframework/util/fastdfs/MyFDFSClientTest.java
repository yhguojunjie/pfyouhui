...
package com.yoxi.jgframework.util.fastdfs;
...
{	
	...
	public static void main(String[] args)
	{
		...
		try
		{
			MyFastDFSClient.init(FileUtils.getClassPath(FastDFSUtils.class) + fdfsConfigFilename,
					FileUtils.getClassPath(FastDFSUtils.class) + fdhtConfigFilename);
