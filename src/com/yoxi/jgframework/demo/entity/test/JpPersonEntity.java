package com.yoxi.jgframework.demo.entity.test;
 ...
 */
@Entity
@Table(name = "t_jwhat_person", schema = "")
...
public class JpPersonEntity implements java.io.Serializable {
	...
	/**生日*/
	@Excel(exportName="生日", exportConvertSign = 0, exportFieldWidth = 30, importConvertSign = 0)
	private java.util.Date birthday;
	/**出生日期*/
	@Excel(exportName="出生日期", exportConvertSign = 0, exportFieldWidth = 30, importConvertSign = 0)
